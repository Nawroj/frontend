...
const ThreatLevelChart = () => {
  ...
  const handleBarClick = (event) => {
    ...
    axios
      .get(`http://localhost:8000/threats/events-by-threat/${levelId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <Plot
      style={{
        ...
        backgroundColor: "#f4f4f5",   // Chart wrapper background
      ...
      layout={{
        ...
        yaxis: {
          title: { text: "Number of Events", font: { size: 16 } },
          tickvals: [0, 500, 1000, 1500, 2000],
        },
        bargap: 0.5,
        showlegend: false,
      ...
      config={{
        displayModeBar: false,  // Hide zoom buttons
